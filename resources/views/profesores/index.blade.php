        ...
        <table class="w-full border-collapse border border-gray-300">
            ...
            @foreach($profesores as $profesor)
                <tr class="border-b border-gray-300">
                    <td class="px-2 py-2 text-center">{{$profesor->nombre}}</td>
                    <td class="px-2 py-2 text-center">{{$profesor->dni}}</td>
                    <td class="px-2 py-2 text-center">{{$profesor->edad}}</td>
                    <td class="px-2 py-2 text-center">{{$profesor->email}}</td>
                    @auth
                        <td class="px-2 py-2 text-center">
                            <a href="{{route("profesores.edit", $profesor->id)}}" class="text-blue-600 hover:text-blue-800 transition-colors duration-300 flex items-center justify-center">
