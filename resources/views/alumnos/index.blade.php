<x-layouts.layout>
    <h1 class="text-4xl font-bold text-red-600 text-center mb-4">Listado de alumnos</h1>
    @if(session()->get("status"))
        <div role="alert" class="alert alert-success flex items-center justify-center mb-8">
    ...
    <div class="flex justify-center">
        <a class="btn btn-primary mx-10 mb-4" href="{{route("alumnos.create")}}">Nuevo alumno</a>
    </div>
    @endauth
    <div class="max-h-[60vh] overflow-y-auto">
        <table class="w-full border-collapse border border-gray-300">
            <thead class="text-xl text-white bg-gray-800 sticky top-0">
                <tr>
            ...
            @foreach($alumnos as $alumno)
                <tr class="border-b border-gray-300">
                    ...
                    <td class="px-4 py-2 text-center">{{$alumno->dni}}</td>
                    <td class="px-4 py-2 text-center">{{$alumno->edad}}</td>
